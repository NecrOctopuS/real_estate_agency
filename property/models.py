...
class Complaint(models.Model):
    user = models.ForeignKey(User, verbose_name='Кто жаловался',
                             on_delete=models.CASCADE, related_name="user_complaints")
    flat = models.ForeignKey(Flat, verbose_name='Квартира, на которую пожаловались',
                             on_delete=models.CASCADE, related_name="flat_complaints")
...
class Owner(models.Model):
    ...
    phone_pure = PhoneNumberField(blank=True, verbose_name='Нормализированный номер владельца')
    flat = models.ManyToManyField(Flat, related_name="flat_owners", verbose_name="Квартиры в собственности", blank=True)
